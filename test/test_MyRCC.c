...
{
   TEST_ASSERT_EQUAL_INT(ECODE_OK, MyRCC_USARTClockEnable(RCC_USART6_EN_REG, USART6_Mask));
   TEST_ASSERT_BIT_HIGH(5, RCC->APB2ENR);

   TEST_ASSERT_EQUAL_INT(ECODE_OK, MyRCC_USARTClockEnable(RCC_USART1_EN_REG, USART1_Mask));
